...
// var fullName = "Abdullah Sajid";
// alert(fullName)

// var age = " 17 years old";
// alert(age)

// var bio = "MERN STACK DEVELOPER";
// alert(bio)
...
// var first$Nam = "Abdullah", last_Name = "Sajid", $age = 17;
...
// var last_name = "Sajid";
// var age$ = 19;
// var $favoriteOutdoorGame = "cricket";
// var $favoriteIndoorGame = "PUBG";

//  Five illegal variable

// var 1firstName = "Abdullah";
// var last+name = "Sajid";
// var age% = 17;
// var var  = "cricket";
// var favorite khel = "PUBG";
...
// var three = 3;
// var five = 5 ;
// console.log("sum of 3 and 5 is " + (three + five))
// var three = 3;
// var five = 5 ;
// console.log("sub of 3 and 5 is " + (three * five))
// var three = 3;
// var five = 5 ;
// console.log("modulas of 3 and 5 is " + (three % five))
...
// var apnaNumber;
// console.log(`Value after variable declaraiton is undefined <br>`)


// //  initialize  the variable with some number

// var apnaNumber = 5;
// console.log(`initialize value ${apnaNum}<br> `)


// // increment the variable

// var incremenNum = ++apnaNumber;
// console.log(` value after increment is: ${incremenNumber} <br>`)

// // add 7 variable

// var addIncremenNumber = incremenNumber + 7;
// console.log(` value after addition is: ${addIncremenNumber} <br>`)

// // Decrement the variable

// var Decrement = --addIncremenNumber;

// console.log(` value after decrement is: ${Decrement} <br>`)

// // remaindar aftar Decrement
// var divide = Decrement - 12 / 1;
// console.log(`the remaindar is ${divide}:`)
...
// console.log(`${ctempToF}C is ${ftempToC}F <br>`)
// console.log(`${ftempToC}C is ${ctempToF}F <br>`)

// question 7

// var priceOfitem1 = 650;
// console.log(`Price of item 1 is ${priceOfitem1} <br>`)

// var Quantityofitem1 = 3;
// console.log(`Quantity of item 1 is ${Quantityofitem1} <br>`)

// var PriceOfitem2 = 100;
// console.log(`Price of item 2 is ${PriceOfitem2} <br>`)

// var Quantityofitem2 = 7;
// console.log(`Quantity of item 2 is ${Quantityofitem2} <br>`)

// var shipping = 100;
// console.log(`Shipping Charge is ${shipping} <br>`)
...
// var totalmark = 980;
// console.log(`Total mark ${totalmark} <br>`)
// var markobtaied = 804;
// console.log(`mark obtaied  ${markobtaied} <br>`)
// console.log(`Percentage ${markobtaied * 100 / totalmark}%`)
...
// var dollar = 104.80;
// var riyal = 28;
// console.log(`Total Currency in PKR: ${dollar * 10 + riyal * 25}`)
...
//     alert(`OMG! Today’s weather is so Good.`)
// }
...
// let operate = prompt('tell me Sir! how can i help you ...?');
...
//     console.log("Good Morning Sir! Serving the breakfast.");
// } else if (currentHour >= 11 && currentHour < 13) {
//     console.log("Good Afternoon Sir! It's the Time for lunch.");
// } else if (currentHour >= 17 && currentHour < 20) {
//     console.log("Good Evening Sir .It's dinner time.");
// } else {
//     console.log("Sorry Sir! you'll have to wait");
// }
...
// let index = prompt("Enter the index.no at which you want to add a color:")
// let colorToAdd = prompt("Enter a color to add at the specified index.no.")
// colors.splice(index, 0, colorToAdd)
// console.log("<br> after adding specific index" + colors)
...
// let index = prompt("Enter the index.no at which you want to delete the color(s):");
// let numberOfColorsToDelete = prompt("Enter the number of colors to delete:");
// colors.splice(index, numberOfColorsToDelete);
// console.log("<br>Updated array after deleting colors from the specified index: " + colors);
...
// movies.push(" 1) The Avengers <br>")
// movies.push(" 2) Peaky Blinders <br>")
// movies.push(" 3) Avengers:Age Of Ultron<br>")
// movies.push(" 4) Avengers:Infinity War <br>")
// movies.push(" 5) Avengers:Endgame <br>")


// console.log(movies + "<br>")
// console.log("Length of array " + movies.length)
...
// const favoriteCars = ["Lamborghini Aventedor SVJ", "Audi E-TRON", "Porsche Carrera GT", "BMW M5" , "Konigsegg JESCO" , "Mustang GT" , "Nissan GTR"];
...
// let theSelectedCities = []

// theSelectedCities = cities.slice(0, 2)

// document.write("Cities" + cities + "<br>")
// document.write("Selected Cities" + theSelectedCities)

//  QUESTION NO 12


// let arr = ["This", "is", "my", "Dog"];
// let str = arr.join(" ");
...
//     subject_Html: 80,
//     student_Css: 69,
//     student_Javascript: 75,
//     student_Bootstrap: 72,
//     total_Marks: 400,
